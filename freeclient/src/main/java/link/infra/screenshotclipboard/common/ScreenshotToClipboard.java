...
/**
 * ScreenshotToClipboard 核心逻辑，从 1.20-arch（yarn 映射）移植到 Forge 1.20.1（mojmap）。
 */
public class ScreenshotToClipboard {
	...
	public static void handleScreenshotAWT(com.mojang.blaze3d.platform.NativeImage img) {
		if (Minecraft.ON_OSX) {
			return;
		}
		...
		long imagePointer = ((NativeImagePointerAccessor) (Object) img).getPixels();
